        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              HomeButton(name: 'knots'.tr, color: Colors.lime, emoji: "🪢", onTap: () => {}),
              HomeButton(name: 'rightsofway'.tr, color: Colors.teal, emoji: "🚢", onTap: () => {}),
              HomeButton(name: 'report'.tr, color: Colors.white10, emoji: "🚨", onTap: () => {}),
              HomeButton(name: 'infos'.tr, color: Colors.white10, emoji: "ℹ️", onTap: () => {}),
